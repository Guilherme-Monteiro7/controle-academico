...
public class ValidaCampos {
    ...
    public static boolean validaEmail(String email) {
        // Refatorado para evitar Catastrophic Backtracking (Estouro de pilha/StackOverflow)
        // Grupos de captura não-gulosos e sem quantificadores sobrepostos.
    ...
    public static boolean validaFormacao(String forma) {
        return forma.matches("\\p{Upper}[\\p{IsLatin}[ ]]+");
    }
